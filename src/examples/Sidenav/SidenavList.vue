    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item url="/tables" :class="getRoute() === 'tables' ? 'active' : ''"
          :navText="this.$store.state.isRTL ? 'الجداول' : 'Get API'">
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item url="/billing" :class="getRoute() === 'billing' ? 'active' : ''"
          :navText="this.$store.state.isRTL ? 'الفواتیر' : 'Post API'">
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item url="/virtual-reality" :class="getRoute() === 'virtual-reality' ? 'active' : ''" :navText="
          this.$store.state.isRTL ? 'الواقع الافتراضي' : 'Put API'
        ">
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item url="/rtl-page" :class="getRoute() === 'rtl-page' ? 'active' : ''" navText="Delete API">
          <template v-slot:icon>
            <i class="fa fa-minus-circle text-danger text-sm opacity-10"></i>
          </template>
        </sidenav-item>
      </li>
